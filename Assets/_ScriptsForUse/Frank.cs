...
public class Frank
{
    ...
    public ShelfLife shelfLifeValue; // Frank's Default Health Bar.
    ...
    public Frank(float speed) // add more parameters to Frank if needed.
    {
        ...
        shelfLifeValue = new ShelfLife(100); // this value is for the Player's character its fixed based on seasoning level.
